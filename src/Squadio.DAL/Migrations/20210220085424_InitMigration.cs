        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RoleId = table.Column<Guid>(nullable: false, defaultValue: new Guid("bf22a3fd-f7eb-4871-b84a-4d8ff51d0f7d")),
                    UITheme = table.Column<int>(nullable: false, defaultValue: 0),
                    SignUpType = table.Column<int>(nullable: false, defaultValue: 0),
